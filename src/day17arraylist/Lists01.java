...
public class Lists01 {
	...
	public static void main(String[] args) {
		...
		//How put element in a specific index
		list1.add(1,13);
		...
		//System.out.println(list1.get(4));//There is no index 4, because you will get run time error
		...
		/*
		 * Type code to find the minumum and maximum value from list2
		 */
		...
		list2.remove(6);//Do not use non existing index in the list you will get exception
		...
		//Remove "Veli" and add "Velihan" in the index of "Veli"
				...
				//1.Way
		int indx= list3.indexOf("Veli");
		list3.remove("Veli");
		list3.add(indx, "Velihan");
